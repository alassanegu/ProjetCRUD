...
class MyPDO
{
    ...
    public function getAll(): array {
        ...
        return $this->getPdosSelectAll()->fetchAll(PDO::FETCH_CLASS,"LesClasses\\".ucfirst($this->getNomTable()));
    }
    ...
    public function get($key, $val) {
        ...
        return $this->getPdosSelect()->fetchObject("LesClasses\\".ucfirst($this->getNomTable()));
    }
